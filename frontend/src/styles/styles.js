const styles = {
  ...
  productDiscountPrice: "font-bold text-[18px] text-[#2dcc82] font-Roboto",
  ...
  button:
    "w-[150px] bg-white h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer",
  cart_button:
    "px-[20px] h-[38px] rounded-[20px] bg-[#2dcc82] flex items-center justify-center cursor-pointer",
