        ...
        <div>
          <input
            ...
            className="text-gray-800
                sm:w-72 w-full sm:mr-5 mr-1 lg:mb-0 mb-4 py-2.5 rounded px-2 focus:outline-none border border-gray-500"
          />
          <button className="bg-[#2dcc82] hover:bg-teal-500 duration-300 px-5 py-2.5 rounded-md text-whie md:w-auto w-full">
            Gửi
          </button>
        </div>
      </div>
