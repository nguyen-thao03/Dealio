          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@myecommercestore.com với số đơn đặt hàng của bạn và giải
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                cách gửi email cho chúng tôi theo địa chỉ
                support@myecommercestore.com hoặc bằng cách gọi cho chúng tôi
                theo số 0123456789 trong khoảng thời gian từ 7 giờ sáng đến 5
                giờ chiều, từ Thứ Hai đến Thứ Sáu.
              </p>
            </div>
          )}
        </div>
          ...
          {activeTab === 5 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                mục bạn đã đặt hàng, bạn có thể trả lại để được hoàn tiền trong
                vòng 30 ngày của việc giao hàng.
              </p>
            </div>
          )}
        </div>
